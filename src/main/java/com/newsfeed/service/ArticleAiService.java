        ...
        try {
            ...
            String systemPrompt = """
                ...
                1. 分类（ai_category）：将文章分到以下5个类别之一：
                   - ai: AI相关新闻（人工智能、大模型、机器学习等）
                   - tech: 科技新闻（互联网、硬件、软件、产品发布等）
                   - domestic: 国内热点新闻（中国国内的重要新闻、政策、社会事件等）
                   - japan: 日本新闻（与日本相关的新闻）
                   - international: 国际重要新闻（全球重大事件、国际关系等）
                ...
                2. 重要性评分（score）：1-10分，10分最重要。按以下5个维度综合评估：
                   ...
                   - 接近性：地理、心理或利益上与目标受众的关联度（本地民生问题对当地媒体重要度极高）
                   - 趣味性/冲突性：内容的反常度、人情味或矛盾张力，决定传播穿透力
                   评分参考：
